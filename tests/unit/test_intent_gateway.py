...
def test_mixed_injection_ood_hard_signal() -> None:
    ...
    assert lab == "ood_mixed_injection" and sc >= 0.9
...
def test_l05_technical_exemption_mixed_with_base64_line() -> None:
...
def test_l05_technical_exemption_jwt_like() -> None:
