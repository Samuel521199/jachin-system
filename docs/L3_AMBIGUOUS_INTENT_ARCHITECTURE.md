...
**与现行 L3 主轴**：入站后完整链（网关/嗅探/语义层/经验/Critic）见 **[architecture/JACHIN_HYBRID_AGENT_ARCHITECTURE.md](./architecture/JACHIN_HYBRID_AGENT_ARCHITECTURE.md)**；本文聚焦**模糊意图**子问题。
