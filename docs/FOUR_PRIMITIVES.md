...
**现行系统总览（实现索引，2026-04）**: [architecture/CURRENT_SYSTEM_ARCHITECTURE.md](./architecture/CURRENT_SYSTEM_ARCHITECTURE.md) · **架构全景（总—分）**: [arch/README.md](./arch/README.md) · **L3 Memory Nexus（SQLite + FastEmbed）**: [architecture/MEMORY_NEXUS_L3.md](./architecture/MEMORY_NEXUS_L3.md)
