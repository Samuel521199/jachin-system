...
def load_config() -> VoiceServerConfig:
    ...
    return VoiceServerConfig(
        ...
        tts_model=os.getenv("JACHIN_TTS_MODEL", "cosyvoice-v3.5-plus").strip() or "cosyvoice-v3.5-plus",
        tts_fast_model=os.getenv("JACHIN_TTS_FAST_MODEL", "cosyvoice-v3.5-flash").strip() or "cosyvoice-v3.5-flash",
