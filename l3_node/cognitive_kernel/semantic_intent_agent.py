...
_APP_ALTERNATIVES: dict[str, list[tuple[str, str, float]]] = {
    ...
    "log": [("Lark", "entity_correction_candidate", 0.9)],
    "look": [("Lark", "entity_correction_candidate", 0.88)],
    "loc": [("Lark", "entity_correction_candidate", 0.86)],
    "lok": [("Lark", "entity_correction_candidate", 0.86)],
