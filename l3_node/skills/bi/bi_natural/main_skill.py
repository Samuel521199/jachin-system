...
def _resolve_raw_natural_dir(cfg: dict[str, Any]) -> Path:
    ...
    from l3_node.mcp_tools.bi.paths import get_bi_raw_natural_dir
...
def run_bi_natural_retention(
    ...
    *,
    ...
    if not skip_collect:
        from l3_node.mcp_tools.bi.tool_natural_retention_collect import run_natural_retention_compare_collect
