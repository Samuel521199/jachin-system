...
def _query_table(conn: Any, slug: str, date_from: str | None = None, date_to: str | None = None) -> list[dict]:
    from l3_node.primitives.mcp.mcp_tools.bi.data_store import _sanitize_table_name
...
def _run_refiner(date_str: str | None = None, output_dir: Path | None = None, raw_dir: Path | None = None) -> tuple[list[Path], list[str]]:
    ...
    from l3_node.primitives.mcp.mcp_tools.bi.paths import get_bi_output_dir, get_bi_raw_dir, ensure_bi_dirs
    ensure_bi_dirs()
...
def _is_duckdb_fresh_for_today() -> bool:
    ...
    try:
        from l3_node.primitives.mcp.mcp_tools.bi.data_store import list_available_dates
    except ImportError:
        return False
...
async def _run_bi_daily_report_async(config: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    from l3_node.primitives.mcp.mcp_tools.bi.paths import get_bi_output_dir, ensure_bi_dirs, get_bi_raw_dir
