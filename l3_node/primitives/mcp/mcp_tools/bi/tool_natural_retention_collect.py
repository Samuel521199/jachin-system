...
def run_natural_retention_compare_collect(
    ...
    *,
    ...
    """
    from l3_node.primitives.mcp.mcp_tools.bi.spa_collector import (
        DEFAULT_BASE_URL,
        DEFAULT_CDP_URL,
        MENU_ITEMS,
        TABLE_SEL,
    ...
    from l3_node.primitives.mcp.mcp_tools.bi.paths import ensure_bi_dirs, get_bi_raw_natural_dir
