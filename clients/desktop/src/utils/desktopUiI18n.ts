...
export const desktopOmniUi = {
  zh: {
    ...
    deleteSession: "删除会话",
    sessionHistory: "会话历史",
    emptyThreadHint: "在此输入或语音，对话将按轮次显示",
    ...
    placeholderL3: "Alt+Shift+Space · 输入或按住说话（L3）…",
  ...
  en: {
    ...
    emptyThreadHint: "Type or speak — messages appear in order",
    ...
    placeholderL3: "Alt+Shift+Space · type or hold to speak (L3)…",
